...
public class Main {
    public static void main(String[] args) {
        ...
        Mechanic<Car> petr = new Mechanic<Car>("Petr", "Петров", "Автодом");
        Mechanic<Truck> vova = new Mechanic<Truck>("Vova", "Петров", "Rolf");
        Mechanic<Bus> garik = new Mechanic<Bus>("Garik", "Петров", "ARAM");
        Sponsor shell = new Sponsor("Роснефть", 2_000_000);
        Sponsor sber = new Sponsor("Сбербанк", 4_000_000);
        ...
        //mercedes.printInfo();mercedes.printType();volvo.printInfo();volvo.printType();
        //scania.printInfo();scania.printType();tiger.printInfo();tiger.printType();
        ...
        //mercedesSl.printInfo();mercedesSl.printType();audi.printInfo();audi.printType();
        //ford.printInfo();ford.printType();bmw.printInfo();bmw.printType();
        //mercedesSl.addDriver(new Driver("Петров Петр Петрович,", "кат.B,", 11.5,
        ...
        //man.printInfo();man.printType();zil.printInfo();zil.printType();
        //kamaz.printInfo();kamaz.printType();gaz.printInfo();gaz.printType();
        ...
        List<Transport> transports = List.of(audi, bmw,
                man, volvo);
        ...
        for (Transport transport : transports) {
            printInfo(transport);
            System.out.println(petr.getCompany());
            System.out.println("Спонсор: " + shell.getName() + " сумма: " + shell.getAmount() + " млн.руб!");
            System.out.println(vova.getCompany());
            System.out.println("Спонсор: " + sber.getName() + " сумма: " + sber.getAmount() + " млн.руб!");
        }
    }

    public static void printInfo(Transport transport) {
        System.out.println("Информация по автомобилю: " + transport.getBrand() + " " + transport.getModel());
        System.out.printf("Водители: " + transport.getDrivers() + " ");
        System.out.printf("Спонсоры: " + transport.getSponsors() + " ");
